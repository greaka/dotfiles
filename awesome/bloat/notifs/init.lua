...
naughty.config.defaults.screen = awful.screen.primary:get_next_in_direction("right")
naughty.config.presets.low.screen = awful.screen.primary:get_next_in_direction("right")
naughty.config.presets.normal.screen = awful.screen.primary:get_next_in_direction("right")
naughty.config.presets.critical.screen = awful.screen.primary:get_next_in_direction("right")
