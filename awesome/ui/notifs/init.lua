...
local target_screen = math.max(math.ceil(screen:instances() / 2) + 1, screen:instances())
naughty.config.defaults.screen = target_screen
naughty.config.presets.low.screen = target_screen
naughty.config.presets.normal.screen = target_screen
naughty.config.presets.critical.screen = target_screen
