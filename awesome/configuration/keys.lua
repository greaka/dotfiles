...
awful.keyboard.append_global_keybindings(
    {
        awful.key({modkey}, "a",
            ...
            group = "tabs"
        }), awful.key({modkey}, "d", function() bling.module.tabbed.pop() end, {
...
awful.keyboard.append_global_keybindings(
    {
        ...
        awful.key({shift, "Control"}, "Print", function()
            awful.spawn.with_shell(gears.filesystem.get_configuration_dir() ..
                                       "scripts/shoot seldlplik")
        end, {description = "take a screenshot and upload it via plik", group = "awesome"}),
        awful.key({modkey, shift, "Control"}, "Print", function()
            awful.spawn.with_shell(gears.filesystem.get_configuration_dir() ..
                                       "scripts/shoot seldlclip")
	end, {description = "take a selection and xclip it", group = "awesome"}),
	awful.key({shift}, "Print", function()
            awful.spawn.with_shell(gears.filesystem.get_configuration_dir() ..
                                       "scripts/shoot seldplik")
        end, {description = "take a screenshot and upload it via plik", group = "awesome"}),
        awful.key({modkey, shift}, "Print", function()
            awful.spawn.with_shell(gears.filesystem.get_configuration_dir() ..
                                       "scripts/shoot seldclip")
        end, {description = "take a selection and xclip it", group = "awesome"}),
        awful.key({}, "Print", function()
            awful.spawn.with_shell(gears.filesystem.get_configuration_dir() ..
                                       "scripts/shoot selplik")
        end, {description = "take a screenshot and upload it via plik", group = "awesome"}),
        awful.key({modkey}, "Print", function()
            awful.spawn.with_shell(gears.filesystem.get_configuration_dir() ..
                                       "scripts/shoot selclip")
        end, {description = "take a selection and xclip it", group = "awesome"}),
